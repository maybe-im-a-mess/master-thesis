...
In terms of reliability and safety, we refer to the ability of LLMs to produce accurate and trustworthy information by avoiding the generation of false or misleading content, as well as ensuring that critical information is not left out. In the medical domain, this can include extracting relevant medical facts from patient health records, extracting drug interactions from experimental studies, or extracting phenotypic traits from genomic reports, among others.
...
Since the advances made in LLMs' performance in the task of information extraction, this thesis will focus solely on the LLM-based approaches. Among these four methods specifically will be explored: 
\begin{itemize}
