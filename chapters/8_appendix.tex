...
This appendix contains the exact system messages and user prompts used across the three \textit{LLM-as-a-Judge} evaluations.
...
Turn 2
Patient: Ich bin in der **39. Woche** und ehrlich gesagt etwas nervös. Ich will vor allem wissen, **wie lange das ungefähr dauert** und ob ich dabei viel Schmerz haben werde.
...
Turn 6
Patient: Okay, das beruhigt mich schon etwas. Ich hab nur Angst, dass ich nicht direkt verstehe, was die mit mir machen und dann alles zu schnell geht. **Wie merke ich denn, ob die Einleitung überhaupt schon wirkt?**
