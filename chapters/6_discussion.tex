...
Thirdly, the marked variation in compliance across different patient personas, the performance with ``Language Barrier'' and ``Trauma History'' profiles in particular, implies that real-world deployments need persona-adaptive dialogue management.
