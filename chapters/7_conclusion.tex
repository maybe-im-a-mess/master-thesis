...
The open-source alternative Ministral-14B with UIE achieved marginally higher F1 and is recommended when maximising recall alignment to a fixed ground truth is the primary objective.
